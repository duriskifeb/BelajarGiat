...
public class DataProduct {
    ...
    public ArrayList<Product> newListProduct() {
        return listProduct = new ArrayList<Product>(
                Arrays.asList(
                        new Product("Soto gabukatuh", 3000, 25, "Ada"),
                        new Product("Ayam goyengan", 3000, 25, "Ada"),
                        new Product("Pentol grubak", 3000, 25, "Ada")));
    }
    ...
    public Product getProduct(String namaProduk) {
        return listProduct.stream()
                .filter(cekProduct -> cekProduct.getNamaBarang().equals(namaProduk))
                .findFirst()
                .orElse(null);
    }
}
